...
namespace Unity.XR.PICO.LivePreview
{
...
#endif
    {
        ...
        public override bool Initialize()
        {
            ...
            PXR_PTApi.UPxr_PTSetSRPState(false);//GraphicsSettings.currentRenderPipeline != null
        ...
        {
            PXR_PTApi.UPxr_PTSetSRPState(/*GraphicsSettings.currentRenderPipeline != null*/ false);
